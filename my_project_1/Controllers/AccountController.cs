...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.usertype = new SelectList(db.Roles.Where(a=>!a.Name.Contains("dminstrator")).ToList()
                                      ,"Name","Name");
            return View();
        }
        ...
        public ActionResult EditeProfile()
        {
            ...
            EditeProfilerViewModel profile = new EditeProfilerViewModel();
        ...
        [HttpPost]
        public ActionResult EditeProfile(EditeProfilerViewModel profile)
        {
            var UserId = User.Identity.GetUserId();
            var CurrentUser = db.Users.Where(a => a.Id == UserId).SingleOrDefault();
            if (!UserManager.CheckPassword(CurrentUser, profile.CurrentPassword))
             {
                ViewBag.Massage = "كلمة السر الحالة غير صحيحة";
            ...
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Massage = "تمت العملية بنجاح";
            }
            return View();
        }
        //
